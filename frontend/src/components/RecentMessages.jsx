        ...
        <div className="flex flex-col max-h-56 overflow-y-auto no-scrollbar">
            {
                ...
                <Link to={`/messages/${message.from_user_id._id}`} key={index} className='flex iytems-start gap-2 py-2 hover:bg-slate-100'>
                    <img src={message.from_user_id.profile_picture} alt="profile_picture" className='w-8 h-8 rounded-full' />
